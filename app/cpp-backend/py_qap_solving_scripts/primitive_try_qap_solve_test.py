...
def test_nrll_with_random_new_element_inserting():
    ...
    assert (
        elements == [8, 41, 10, 1, 2, 3, 4, 7]
        and index_correctness
        and postfix_index_correctness
    )
...
def test_nrll_reservering():
    ...
    while node is not None:
        ...
        next_node = node.next
        next_pointers.append(None if next_node is None else next_node.contents)
        node = next_node

    assert (
        elements == [7, 4, 3, 2, 1, 10, 41, 8]
        and previous_pointers == [None, 7, 4, 3, 2, 1, 10, 41]
        and next_pointers == [4, 3, 2, 1, 10, 41, 8, None]
        and index_correctness
        and postfix_index_correctness
    )
...
def test_end_merging():
    ...
    assert (
        elements == [8, 41, 10, 1, 2, 3, 4, 7, 3, 50, 44, 5, 15, 7]
        and previous_pointers == [None, 8, 41, 10, 1, 2, 3, 4, 7, 3, 50, 44, 5, 15]
        and next_pointers == [41, 10, 1, 2, 3, 4, 7, 3, 50, 44, 5, 15, 7, None]
        and index_correctness
        and postfix_index_correctness
        and nrll_2.head is None
        and nrll_2.tail is None
    )
...
def test_end_merging():
    ...
    assert (
        elements == [3, 50, 44, 5, 15, 7, 8, 41, 10, 1, 2, 3, 4, 7]
        and previous_pointers == [None, 3, 50, 44, 5, 15, 7, 8, 41, 10, 1, 2, 3, 4]
        and next_pointers == [50, 44, 5, 15, 7, 8, 41, 10, 1, 2, 3, 4, 7, None]
        and index_correctness
        and postfix_index_correctness
        and nrll_2.head is None
        and nrll_2.tail is None
