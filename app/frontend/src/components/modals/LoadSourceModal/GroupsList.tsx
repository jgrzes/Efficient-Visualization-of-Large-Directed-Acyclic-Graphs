  ...
  return (
    <div className="md:w-1/2 w-full flex flex-col">
      <div className="flex items-center justify-between mb-2">
        <span className="text-[11px] text-gray-700 dark:text-gray-300">Existing groups</span>
        ...
        {filteredGroups.length === 0 ? (
          ...
          filteredGroups.map((g) => (
            <button
              ...
              className={`
                w-full text-left rounded-lg px-2.5 py-1.5 text-[11px]
                border flex flex-col gap-0.5 transition
                ${
