...
const CommentsPanel: React.FC<CommentsPanelProps> = ({
  ...
  return (
    <div className="flex h-full min-w-0 flex-col text-sm text-gray-700 dark:text-gray-300">
      {/* HEADER */}
      <div
        className="
          px-4 pt-3 pb-3
      ...
      >
        <div className="flex items-center justify-between gap-2">
          <p className="text-gray-600 dark:text-gray-400 uppercase tracking-wide text-xs">
            Comments
          </p>
