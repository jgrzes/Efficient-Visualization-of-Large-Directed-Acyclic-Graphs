      ...
      .then((data) => {
        ...
        if (data.config) {
          setGraphConfig({
            ...
            colors: {
              default: (data.config as any).default_color ?? DEFAULT_GRAPH_COLORS.default,
              parent: (data.config as any).parent_color ?? DEFAULT_GRAPH_COLORS.parent,
              child: (data.config as any).child_color ?? DEFAULT_GRAPH_COLORS.child,
              selected: (data.config as any).selected_color ?? DEFAULT_GRAPH_COLORS.selected,
              hover: (data.config as any).hover_color ?? DEFAULT_GRAPH_COLORS.hover,
              search: (data.config as any).search_color ?? DEFAULT_GRAPH_COLORS.search,
            }
          });
        } else {
          setGraphConfig({
    ...
    try {
      ...
      if (data.config) {
        setGraphConfig({
          ...
          pointSize: data.config.point_size || 1,
          colors: {
            default: data.config.default_color ?? DEFAULT_GRAPH_COLORS.default,
            parent: data.config.parent_color ?? DEFAULT_GRAPH_COLORS.parent,
            child: data.config.child_color ?? DEFAULT_GRAPH_COLORS.child,
            selected: data.config.selected_color ?? DEFAULT_GRAPH_COLORS.selected,
            hover: data.config.hover_color ?? DEFAULT_GRAPH_COLORS.hover,
            search: data.config.search_color ?? DEFAULT_GRAPH_COLORS.search,
          }
        });
      } else {
        setGraphConfig({
